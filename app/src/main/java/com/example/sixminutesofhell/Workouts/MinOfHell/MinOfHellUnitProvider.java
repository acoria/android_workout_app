...
public class MinOfHellUnitProvider extends UnitProvider {
    ...
    protected void initialize() {
        ...
        addUnitToStack(new Break());
        addUnitToStack(new Exercise("Step-up onto chair, right", IUnitConfig.UnitLengthType.UNIT_LENGTH_SHORT));
        addUnitToStack(new Exercise("Step-up onto chair, left", IUnitConfig.UnitLengthType.UNIT_LENGTH_SHORT));
        addUnitToStack(new Break());
        ...
        addUnitToStack(new Break());
        addUnitToStack(new Exercise("Lunge right", IUnitConfig.UnitLengthType.UNIT_LENGTH_SHORT));
        addUnitToStack(new SpecialUnit("Change side", IUnitConfig.UnitLengthType.UNIT_LENGTH_SWAP_SIDE));
        addUnitToStack(new Exercise("Lunge left", IUnitConfig.UnitLengthType.UNIT_LENGTH_SHORT));
        addUnitToStack(new Break());
